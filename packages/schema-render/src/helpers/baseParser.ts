 ...
 * @param arr
 */
export function getPropValueFromArray(arr: any[], context: SchemaRenderContextProps = {}): any[] {
...
// 获取所有属性
export function getProps(props: Record<any, any>, context: SchemaRenderContextProps = {}) {
