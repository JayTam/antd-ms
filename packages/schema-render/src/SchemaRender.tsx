...
import { SchemaRenderContext, arraySchemaToComponent, objectSchemaToComponent } from './helpers';
...
export const SchemaRender: FC<SchemaRenderProps> = memo(({ schema }) => {
  ...
  if (typeof schema === 'object') return objectSchemaToComponent(schema, context);
  return null;
});
