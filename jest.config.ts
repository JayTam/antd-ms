  ...
  try {
    const config = await configUmiAlias({
      ...
      moduleNameMapper: {
        ...
        '^@jaytam/icons$': '<rootDir>/packages/ms-icons/src/index.ts',
        '^@jaytam/icons/(.*)$': '<rootDir>/packages/ms-icons/src/$1',
        '^@jaytam/request-ms$': '<rootDir>/packages/ms-request/src/index.ts',
        '^@jaytam/request-ms/(.*)$': '<rootDir>/packages/ms-request/src/$1',
        '^@jaytam/schema-render$': '<rootDir>/packages/schema-render/src/index.tsx',
        '^@jaytam/schema-render/(.*)$': '<rootDir>/packages/schema-render/src/$1',
        '^@jaytam/ms-flow$': '<rootDir>/packages/ms-flow/src/index.ts',
        '^@jaytam/ms-flow/(.*)$': '<rootDir>/packages/ms-flow/src/$1',
        '^@jaytam/ms-gantt$': '<rootDir>/packages/ms-gantt/src/index.ts',
        '^@jaytam/ms-gantt/(.*)$': '<rootDir>/packages/ms-gantt/src/$1',
      },
