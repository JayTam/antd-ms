...
import type { EditConfig, MsFormProps } from '../../components/MsForm/types';

export type MsPresetResourceTagsProps = MsFieldBaseProps<
  ResourceTagsEditorProps | ResourceTagsReadProps
> & { editable?: EditConfig<any> };

export type MsPresetResourceTagsRef = Ref<any>;

export interface ResourceTagsTableCellProps {
  resource?: ResourceType;
  onRefresh?: () => void;
  hideEditInTable?: boolean;
  popoverProps?: PopoverProps;
}

export interface ResourceTagsSearchFormProps {
  initialValues?: MsFormProps['initialValues'];
  onFinish?: MsFormProps['onFinish'];
  onReset?: () => void;
  onClose?: () => void;
}
