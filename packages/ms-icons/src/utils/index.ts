...
import { AbstractNode, IconDefinition } from '../components/type';
...
export function warning(valid: boolean, message: string) {
  warn(valid, `[@jaytam/antd-ms/MsSvg] ${message}`);
}
...
.anticon-spin {
  display: inline-block;
  -webkit-animation: loadingCircle 2s infinite linear !important;
  animation: loadingCircle 2s infinite linear !important;
}
