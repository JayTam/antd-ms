...
`antd-ms` 遵循 [Semantic Versioning 2.0.0](/guide/standard#版本号规范) 语义化版本规范。结合下面的 [更新日志](/guide/changelog#更新日志)、<a href="https://example.com/wiki" target="_blank">正式版问题</a> 和 <a href="https://example.com/wiki" target="_blank">Breaking Changes</a>，可以更全面地掌握组件库的更新状态与潜在影响。​
...
- **ms-user-group:** 新增XX群选择 ([6e35170](https://github.com/JayTam/antd-ms/commit/6e35170c160d290dd8779eede69b66de797bdc31))
...
- **ms-request:** 业务系统状态码更新，前端同步调整 ([90905f1](https://github.com/JayTam/antd-ms/commit/90905f1e3558bd8e4672d8f43cc654fab683af2b))
- **ms-request:** 业务系统状态码同步更新 ([e9c5b53](https://github.com/JayTam/antd-ms/commit/e9c5b53bdd067fac0592e1b479652c783e922e1a))
...
- **ms-request:** 根据业务要求，新增剔除业务系统业务的 define-request，保留大部分 ms-request 的功能的同时部分开放自定义 api 供业务方自由调整 ([8cb5238](https://github.com/JayTam/antd-ms/commit/8cb5238d4d93a2e6eb40cc450a890607050b84a2))
...
- **ms-request:** 新增 envsToLoginAddress 根据环境变量跳转登录，兼容除业务系统外其他项目登录需求 ([9374fdf](https://github.com/JayTam/antd-ms/commit/9374fdf9aecaa12d803660d8177ead001299d71a))
...
- **ms-request:** 实名认证业务系统定义统一 code ([a82e789](https://github.com/JayTam/antd-ms/commit/a82e789d3c0cce92fa24e05ea178c093d57ebd03))
