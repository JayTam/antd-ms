...
} from '../../../../MsTable/components/MsTableColumnContainer/types';
import { columnsToColumnState } from '../../../../MsTable/components/MsTableColumnContainer/utils/state';
import ColumnSelect from '../../../../MsTable/components/MsTableColumnContainer/components/ColumnSelect';
import ColumnSort from '../../../../MsTable/components/MsTableColumnContainer/components/ColumnSort';
import type { MsTableColumns } from '@jaytam/antd-ms/components/MsTable';
...
const ColumnSetModal = MsModal.create((props: ColumnSetModalProps) => {
  const { columns: formColumns, defaultState, resetState, onFinish } = props;

  const columns = useMemo(() => formColumns as MsTableColumnsWithKey, [formColumns]);
