...
export type diffChangesType =
  | { changed?: number; blockNum?: number; changes?: Record<string, any>[] }
  | undefined;
...
export interface MonacoDiffEditorProps extends Omit<MonacoEditorBaseProps, 'defaultValue'> {
  /**
   ...
   */
  value?: Record<'original' | 'modified', any>;
  defaultValue?: Record<'original' | 'modified', any>;
  ...
  diffChanges?: (changes: diffChangesType) => void;
}
